...
const Lorem = () => {
  return (
    <div className="flex-col my-10 text-center items-center justify-center">
      <h2 className="text-4xl mb-5">Welcom to emotion cafe!</h2>
      ...
      <div className="md:flex flex-row items-center justify-evenly my-5">
        <img
          src={Pic1}
          className="w-96 h-60 md:mr-5 md:ml-0 ml-14 mb-10 md:mb-0 rounded-3xl shadow-2xl shadow-slate-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none duration-200"
          alt="cafe1"
        />
        <img
          src={Pic2}
          className="w-96 h-60 md:ml-5 ml-14 rounded-3xl shadow-2xl shadow-slate-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none duration-200"
          alt="cafe2"
        />
      </div>
    </div>
