...
const Menu = () => {
  const [refrence, setRef] = useContext(RefContext) 
  return (
    <div ref={setRef} className="items-center justify-center text-center my-20 px-5">
      <div className="mb-10 text-orange-500">
        <h1 className="md:text-6xl text-5xl mb-5 font-bold">
          Here's the menu!
        </h1>
